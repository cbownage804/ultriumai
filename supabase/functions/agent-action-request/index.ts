...
const RISK: Record<string, RiskEntry> = {
  ...
  enable_firewall:                 { risk: 'low',    rollback: 'disable_firewall' },
  disable_firewall:                { risk: 'high',   rollback: 'enable_firewall' },
  enable_defender:                 { risk: 'low',    rollback: null },
  update_defender_signatures:      { risk: 'low' },
  enable_defender_pua:             { risk: 'low',    rollback: 'disable_defender_pua' },
  disable_defender_pua:            { risk: 'medium', rollback: 'enable_defender_pua' },
  enable_defender_cloud:           { risk: 'low',    rollback: 'disable_defender_cloud' },
  disable_defender_cloud:          { risk: 'medium', rollback: 'enable_defender_cloud' },
  ...
  enable_rdp:                      { risk: 'high',   rollback: 'disable_rdp' },
  enable_rdp_nla:                  { risk: 'medium', rollback: 'disable_rdp_nla' },
  disable_rdp_nla:                 { risk: 'high',   rollback: 'enable_rdp_nla' },
  disable_remote_assistance:       { risk: 'medium', rollback: 'enable_remote_assistance' },
  enable_remote_assistance:        { risk: 'medium', rollback: 'disable_remote_assistance' },
  disable_browser_password_manager:{ risk: 'medium', rollback: 'enable_browser_password_manager' },
  enable_browser_password_manager: { risk: 'medium', rollback: 'disable_browser_password_manager' },
  remove_local_admin:              { risk: 'high' },
  disable_builtin_administrator:   { risk: 'high',   rollback: 'enable_builtin_administrator' },
  enable_builtin_administrator:    { risk: 'high',   rollback: 'disable_builtin_administrator' },
