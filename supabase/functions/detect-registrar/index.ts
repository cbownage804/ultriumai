...
const REGISTRAR_MAP: Array<{
...
}> = [
  {
    ...
    instructions: [
      ...
      'Add an A record: Name = @ (root domain), Value = 159.203.128.171',
      'Add an A record: Name = www, Value = 159.203.128.171',
  ...
  },
  {
    ...
    instructions: [
      ...
      'Click "Add Record"',
      'Add an A record: Name = @ (root domain), Content = 159.203.128.171, Proxy status = DNS only (gray cloud)',
      'Add an A record: Name = www, Content = 159.203.128.171, Proxy status = DNS only (gray cloud)',
  ...
  },
  {
    ...
    instructions: [
      ...
      'Add an A record: Host = @, Value = 159.203.128.171',
      'Add an A record: Host = www, Value = 159.203.128.171',
  ...
  },
  {
    ...
    instructions: [
      ...
      'Add an A record: Host = @, Data = 159.203.128.171',
      'Add an A record: Host = www, Data = 159.203.128.171',
      'Add a TXT record: Host = _ultriumai, Value = (shown below)',
    ],
  },
  {
    ...
    instructions: [
      ...
      'Add an A record: Host = @, Answer = 159.203.128.171',
      'Add an A record: Host = www, Answer = 159.203.128.171',
      'Add a TXT record: Host = _ultriumai, Value = (shown below)',
    ],
  },
  {
