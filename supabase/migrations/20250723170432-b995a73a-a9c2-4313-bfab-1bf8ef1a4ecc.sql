...
-- 3 queued commands (all queued to avoid constraint issues)
...
('00000000-0000-0000-0000-000000000102','checkin_now','{}','queued'),
('00000000-0000-0000-0000-000000000103','restart_service','{}','queued');