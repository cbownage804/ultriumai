...
CREATE TABLE public.ticket_activities (
  ...
  user_id UUID NOT NULL,
  activity_type TEXT NOT NULL CHECK (activity_type IN ('created', 'updated', 'commented', 'assigned', 'status_changed', 'priority_changed', 'resolved', 'closed', 'reopened')),
  description TEXT NOT NULL,
  old_values JSONB,
  new_values JSONB,
...
CREATE POLICY "System can insert ticket activities" ON public.ticket_activities
