...
INSERT INTO public.safenet_devices (id, device_name, ip_address, hostname, connector_key, status, device_type)
VALUES
('00000000-0000-0000-0000-000000000101','WS-01','192.168.1.10','WS-01','ck-test-123','online','workstation'),
('00000000-0000-0000-0000-000000000102','SRV-01','192.168.1.20','SRV-01','ck-test-123','active','server'),  
('00000000-0000-0000-0000-000000000103','LAPTOP-01','10.0.0.55','LAPTOP-01','ck-test-123','offline','laptop')
