...
-- RLS policies for rmm_command_results (no user restriction for now, will be handled at application level)
CREATE POLICY "Authenticated users can manage command results" ON public.rmm_command_results FOR ALL 
