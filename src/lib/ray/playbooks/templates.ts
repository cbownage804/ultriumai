...
export const PLAYBOOK_TEMPLATES: PlaybookTemplate[] = [
  ...
  // ── Wrayth 4.0 — Provider-aware "Secure With Ray" playbooks ──────────
  {
    slug: 'secure-github',
    title: 'Secure your GitHub account',
    description: "Your code is your IP. Let's lock it down.",
    category: 'account',
    estimated_minutes: 5,
    reward_score: 10,
    steps: [
      { task: 'review_account', externalUrl: 'https://github.com/settings/security', externalLabel: 'Open GitHub Security' },
      { task: 'add_passkey', externalUrl: 'https://github.com/settings/security', externalLabel: 'Add a passkey' },
      { task: 'enroll_authenticator_app', externalUrl: 'https://github.com/settings/two_factor_authentication/setup/intro', externalLabel: 'Set up 2FA' },
      { task: 'store_recovery_codes' },
      { task: 'audit_oauth_apps', externalUrl: 'https://github.com/settings/applications', externalLabel: 'Review connected apps' },
      { task: 'revoke_unknown_sessions', externalUrl: 'https://github.com/settings/sessions', externalLabel: 'Review active sessions' },
    ],
    completion: "GitHub is locked: passkey, 2FA, recovery codes saved, and no stale OAuth apps.",
  },
  {
    slug: 'secure-apple',
    title: 'Secure your Apple ID',
    description: "One account spans every Apple device you own.",
    category: 'account',
    estimated_minutes: 5,
    reward_score: 10,
    steps: [
      { task: 'review_account', externalUrl: 'https://appleid.apple.com', externalLabel: 'Open Apple ID' },
      { task: 'enable_mfa', rayPrompt: "Turn on two-factor authentication for your Apple ID." },
      { task: 'verify_recovery_email' },
      { task: 'add_recovery_phone' },
      { task: 'verify_device' },
      { task: 'confirm_done' },
    ],
    completion: "Apple ID is protected with 2FA and recovery you control.",
  },
  {
    slug: 'secure-amazon',
    title: 'Secure your Amazon account',
    description: "Payment methods, addresses, and AWS — all behind one login.",
    category: 'account',
    estimated_minutes: 4,
    reward_score: 8,
    steps: [
      { task: 'review_account', externalUrl: 'https://www.amazon.com/a/settings/approval', externalLabel: 'Open Login & Security' },
      { task: 'enable_mfa', externalUrl: 'https://www.amazon.com/a/settings/approval', externalLabel: 'Turn on 2-Step' },
      { task: 'enroll_authenticator_app' },
      { task: 'verify_recovery_email' },
      { task: 'revoke_unknown_sessions' },
    ],
    completion: "Amazon is on 2-Step with an authenticator app. No SMS, no surprises.",
  },
  {
    slug: 'secure-facebook',
    title: 'Secure your Facebook account',
    description: "A frequent attacker target — let's harden it.",
    category: 'account',
    estimated_minutes: 4,
    reward_score: 8,
    steps: [
      { task: 'review_account', externalUrl: 'https://www.facebook.com/security', externalLabel: 'Open Facebook Security' },
      { task: 'enable_mfa', externalUrl: 'https://www.facebook.com/security/2fac/settings', externalLabel: 'Turn on 2FA' },
      { task: 'enroll_authenticator_app' },
      { task: 'store_recovery_codes' },
      { task: 'audit_oauth_apps', externalUrl: 'https://www.facebook.com/settings?tab=applications', externalLabel: 'Review connected apps' },
      { task: 'revoke_unknown_sessions' },
    ],
    completion: "Facebook is on 2FA with an authenticator and only the apps you trust.",
  },
  {
    slug: 'secure-dropbox',
    title: 'Secure your Dropbox account',
    description: "Files you can't afford to lose — let's lock them down.",
    category: 'account',
    estimated_minutes: 4,
    reward_score: 8,
    steps: [
      { task: 'review_account', externalUrl: 'https://www.dropbox.com/account/security', externalLabel: 'Open Dropbox Security' },
      { task: 'enable_mfa', externalUrl: 'https://www.dropbox.com/account/security', externalLabel: 'Turn on 2-Step' },
      { task: 'enroll_authenticator_app' },
      { task: 'verify_device' },
      { task: 'revoke_unknown_sessions' },
    ],
    completion: "Dropbox is on 2-Step and only your trusted devices have access.",
  },
];
