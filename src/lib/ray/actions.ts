...
export function quickRoute(utterance: string): RayAction | null {
  ...
  if (navMatch) {
    ...
    const map: Record<string, { path: string; label: string }> = {
      ...
      'passwords': { path: '/app/passwords', label: 'your passwords' },
      'password vault': { path: '/app/passwords', label: 'your passwords' },
      'vault': { path: '/app/passwords', label: 'your passwords' },
      'threats': { path: '/app/threats', label: 'the threat scanner' },
      'threat scanner': { path: '/app/threats', label: 'the threat scanner' },
      'scan': { path: '/app/threats', label: 'the threat scanner' },
      'exposure': { path: '/app/exposure', label: 'your exposure' },
