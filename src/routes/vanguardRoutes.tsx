...
export const getVanguardProtectedRoutes = () => [
  ...
  <Route key="vanguard-compliance" path="compliance" element={<GatedPage component={ComplianceAuditor} requiredAddon="comply" featureName="Compliance Auditor" featureDescription="Automated compliance auditing with framework mapping and evidence collection." />} />,
  ...
  // New feature routes
  <Route key="vanguard-threat-intel" path="threat-intel" element={<GatedPage component={ThreatIntelligence} requiredAddon="pursuit-xdr" featureName="Threat Intelligence" featureDescription="Real-time threat intelligence feeds and IOC tracking across your managed fleet." />} />,
  <Route key="vanguard-dark-web" path="dark-web" element={<GatedPage component={DarkWebMonitor} requiredAddon="pursuit-xdr" featureName="Dark Web Monitor" featureDescription="Monitor dark web marketplaces for exposed credentials and data related to your clients." />} />,
  <Route key="vanguard-uba" path="user-behavior" element={<GatedPage component={UserBehaviorAnalytics} requiredAddon="pursuit-xdr" featureName="User Behavior Analytics" featureDescription="AI-driven behavioral analysis to detect insider threats and compromised accounts." />} />,
  <Route key="vanguard-siem" path="siem" element={<GatedPage component={SIEMDashboard} requiredAddon="pursuit-xdr" featureName="SIEM Dashboard" featureDescription="Security information and event management with cross-client log correlation." />} />,
  ...
  <Route key="vanguard-scorecard" path="scorecard" element={<GatedPage component={ComplianceScorecard} requiredAddon="comply" featureName="Compliance Scorecard" featureDescription="Real-time compliance posture scoring across SOC 2, HIPAA, and ISO 27001 frameworks." />} />,
  ...
  <Route key="vanguard-playbooks" path="playbooks" element={<GatedPage component={IncidentResponsePlaybooks} requiredAddon="pursuit-xdr" featureName="Incident Response Playbooks" featureDescription="Automated incident response workflows with MITRE ATT&CK mapped playbooks." />} />,
  ...
  <Route key="vanguard-security-reports" path="security-reports" element={<GatedPage component={LedgerSecurityPage} requiredAddon="pursuit-xdr" featureName="Security Reports" featureDescription="Comprehensive security analytics and threat reporting across your managed environments." />} />,
  <Route key="vanguard-scheduled-scans" path="scheduled-scans" element={<LazyProtectedPage component={LedgerScheduledPage} />} />,
  <Route key="vanguard-compliance-reports" path="compliance-reports" element={<GatedPage component={LedgerCompliancePage} requiredAddon="comply" featureName="Compliance Reports" featureDescription="Framework compliance analytics and audit-ready report generation." />} />,
  <Route key="vanguard-attack-paths" path="attack-paths" element={<GatedPage component={LedgerAttackPathsPage} requiredAddon="pursuit-xdr" featureName="Attack Path Analysis" featureDescription="Visualize and analyze potential attack vectors across your managed infrastructure." />} />,
