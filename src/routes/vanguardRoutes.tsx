...
const VanguardFeatures = lazy(() => import('@/pages/vanguard/VanguardFeatures'));
...
export const getVanguardPublicRoutes = () => [
  ...
  <Route key="vanguard-features" path="features" element={<LazyPage component={VanguardFeatures} />} />,
];
