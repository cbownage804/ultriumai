...
import { CortexAnalyticsDashboard } from '@/components/vanguard/cortex';
import { ModuleLogo } from '@/components/vanguard/ModuleLogo';

export default function CortexAnalyticsPage() {
  useEffect(() => {
    document.title = 'AI Analytics | Vanguard Cortex';
  }, []);
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground">AI performance metrics and ROI tracking</p>
        </div>
      </div>
