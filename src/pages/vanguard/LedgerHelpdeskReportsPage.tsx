...
export default function LedgerHelpdeskReportsPage() {
  useEffect(() => {
    document.title = 'Helpdesk Reports | Vanguard Ledger';
  }, []);
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Ticket volume, SLA compliance, and technician performance</p>
        </div>
      </div>
