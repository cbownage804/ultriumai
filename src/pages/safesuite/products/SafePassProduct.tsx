...
export default function VaultProduct() {
  return (
    <div className="min-h-screen bg-background safe-area-inset-bottom">
      {/* Header */}
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur border-b border-yellow-500/10 safe-area-inset-top">
        <div className="container mx-auto px-4 h-16 sm:h-20 flex items-center justify-between">
          <Link to="/app" className="flex items-center">
            <div className="h-10 sm:h-14 rounded-xl bg-black flex items-center justify-center overflow-hidden border border-yellow-500/20 px-3 sm:px-4 shadow-lg shadow-yellow-500/10">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <Link to="/auth?tab=signup">
              <Button className="bg-yellow-500 hover:bg-yellow-600 text-black touch-target text-sm sm:text-base">
                Get Started
              </Button>
            </Link>
          </div>
      ...
      <section className="relative min-h-[50vh] sm:min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 py-12 sm:py-20">
          <Badge className="mb-4 sm:mb-6 bg-yellow-500/10 text-yellow-400 border-yellow-500/30">
            Included with Wrayth
          </Badge>
          <div className="flex justify-center mb-6 sm:mb-8">
            <div className="bg-black px-8 sm:px-12 py-4 sm:py-6 rounded-xl shadow-[0_0_60px_rgba(245,158,11,0.3)] border border-yellow-500/20">
              <img 
                src={safepassLogo} 
                alt="Vault" 
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
            <Link to="/auth?tab=signup">
              <Button size="lg" className="w-full sm:w-auto bg-yellow-500 hover:bg-yellow-600 text-black gap-2 touch-target">
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {features.map((feature, index) => (
              <Card key={index} className="bg-card border-yellow-500/10 hover:border-yellow-500/30 transition-all">
                <CardContent className="p-4 sm:p-6">
                  <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-lg bg-yellow-500/10 flex items-center justify-center mb-3 sm:mb-4">
                    <feature.icon className="h-5 w-5 sm:h-6 sm:w-6 text-yellow-400" />
                  </div>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            {highlights.map((highlight, index) => (
              <div key={index} className="flex items-center gap-3 p-3 sm:p-4 rounded-lg bg-card border border-yellow-500/10">
