...
import {
  ...
  GitBranch, Network, Sparkles, Coins, Brain, ArrowUpRight,
} from 'lucide-react';
...
const TILES: Tile[] = [
  ...
  { id: 'malware',         label: 'Malware Analysis', desc: 'Explain what a binary or hash actually does, step by step.',                                                    icon: Bug,        cost: 4,  status: 'soon' },
  { id: 'scripts',         label: 'Script Analysis',  desc: 'Paste PowerShell, Bash, Python — get intent, risk, and MITRE.',                                                 icon: Terminal,   cost: 2,  status: 'soon' },
