...
import { FileText, Check, Star, Zap, Users, Shield, ArrowRight, Play } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20">
        ...
        <section className="py-16 bg-muted/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Advanced Document Management</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Comprehensive document management with enterprise security and collaboration features
              </p>
            </div>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Try SafeDoc Live</h2>
              <p className="text-muted-foreground">
                Experience our document management platform with sample documents and collaboration features
              </p>
            </div>
            <SafeDocDemo />
          </div>
        ...
        <section className="py-20 bg-muted/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold mb-4">Choose Your SafeDoc Plan</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
        ...
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <Card className="p-8 bg-gradient-to-br from-primary/5 to-secondary/5">
              <CardContent>
                <h3 className="text-2xl font-bold mb-4">Ready to Secure Your Documents?</h3>
                <p className="text-muted-foreground mb-6">
                  Join thousands of organizations managing their documents securely with SafeDoc
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button size="lg" className="btn-glow">
                    Start Free Trial
