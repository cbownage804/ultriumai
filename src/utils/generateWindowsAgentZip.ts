...
// This will automatically fetch the latest release from your GitHub repo
const GITHUB_RELEASE_BASE_URL = 'https://github.com/UltriumAI/ultra-kb-nexus-assistant/releases/latest/download';
