...
export const SAFESUITE_TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    description: 'This shows your overall security health. A higher score means better protection. Complete tasks like enabling 2FA and strengthening passwords to improve it.',
  ...
  },
  {
    id: 'quick-actions',
    title: 'Quick Actions',
    description: 'Use these shortcuts to quickly add passwords, run scans, or check for breaches. Everything you need is just one click away.',
  ...
  },
  {
    ...
    description: 'Start by saving your first password or running a security scan. Need help? Click the ? icon in the header to access tours and guides anytime.',
    position: 'center',
  },
];
