...
export const STANDALONE_PRODUCTS: Record<string, ProductPricing> = {
  ...
  safenet: {
    id: 'safenet',
    name: 'SafeNet™',
    description: 'Network discovery, topology mapping, and vulnerability assessment',
    price: 19900, // $199/mo flat
    unit: 'org',
    stripePriceId: 'price_safenet_monthly',
    stripeProductId: 'prod_safenet',
    competitorComparison: 'vs Qualys at $5,000/yr',
    savings: '52% cheaper',
    inVanguard: true,
  ...
  safemdr: {
    id: 'safemdr',
    name: 'SafeMDR™',
    description: '24/7 managed detection and response with AI-powered SOC',
    price: 500, // $5/endpoint/mo
    unit: 'endpoint',
    stripePriceId: 'price_safemdr_monthly',
    stripeProductId: 'prod_safemdr',
    competitorComparison: 'vs Arctic Wolf at $15/endpoint',
    savings: '67% cheaper',
    inVanguard: true,
    demoUrl: '/demos/safemdr',
    category: 'security',
  },
  safeshield: {
    id: 'safeshield',
    name: 'SafeShield™',
    description: 'Next-gen antivirus with AI threat prevention and quarantine',
    price: 200, // $2/endpoint/mo
    unit: 'endpoint',
    stripePriceId: 'price_safeshield_monthly',
    stripeProductId: 'prod_safeshield',
    competitorComparison: 'vs SentinelOne at $6/endpoint',
    savings: '67% cheaper',
    inVanguard: true,
