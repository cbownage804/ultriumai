        ...
        {isMenuOpen && (
          <div className="md:hidden bg-background/95 backdrop-blur-md border-t border-border/50">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <a href="/ultriumgpt" className="block px-3 py-2 text-foreground/80 hover:text-foreground">
                UltriumGPT
              </a>
              ...
              <a href="#demo" className="block px-3 py-2 text-foreground/80 hover:text-foreground">
                Live Demos
              </a>
