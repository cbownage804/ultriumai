...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    industry: 'Cybersecurity',
    quote: "The MDR service from Ultrium provides 24/7 coverage our team couldn't offer alone. Their expert analysts have caught threats we would have missed, protecting our clients' critical data.",
    rating: 5,
    results: [
