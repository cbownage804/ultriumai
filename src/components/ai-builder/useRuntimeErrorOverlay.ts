...
(function(){
  ...
  function createOverlay(){
    ...
    overlay.innerHTML='<div style="max-width:600px;width:100%;text-align:center"><h2 style="color:#f87171;font-size:18px;margin:0 0 8px">⚠️ Runtime Error</h2><p style="color:rgba(255,255,255,0.6);font-size:13px;margin:0 0 16px">An error occurred while running your app</p><div id="__re-list" style="text-align:left;width:100%"></div><button id="__re-dismiss" style="margin-top:16px;padding:6px 16px;border-radius:6px;border:1px solid rgba(255,255,255,0.15);background:rgba(255,255,255,0.08);color:#fff;cursor:pointer;font-size:12px">Dismiss</button></div>';
