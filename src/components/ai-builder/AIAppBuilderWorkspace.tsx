...
export function AIAppBuilderWorkspace() {
  ...
  return (
    <TooltipProvider delayDuration={300}>
      ...
      <ExportButton projectName={project.name} files={project.files} supabaseConfig={supabaseConfig} stripeConfig={stripeConfig} serviceKeys={serviceKeys} envVars={envVars} cdnPackages={cdnPackages} />
      {pendingConflicts && (
