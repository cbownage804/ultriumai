...
import { History, RotateCcw, ChevronDown, ChevronRight, FileDiff, Clock } from 'lucide-react';
...
export function VersionHistoryPanel({ versions, currentFiles, onRestore, onClose, open }: VersionHistoryPanelProps) {
    ...
    <div className="w-72 h-full border-r border-white/[0.06] bg-[#0a0a10] flex flex-col shrink-0">
      ...
      <ScrollArea className="flex-1">
        <div className="p-2 space-y-1">
          {[...allVersions].reverse().map((version, idx) => {
            ...
            return (
              <div key={version.id} className="rounded-lg border border-white/[0.04] bg-white/[0.02]">
                <button
