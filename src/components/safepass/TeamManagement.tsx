          ...
          <DialogContent>
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-2">
                ...
                <Button onClick={handleCreateTeam} className="flex-1 bg-gradient-primary">
                  Create Team
                </Button>
              </div>
            </div>
                                  ...
                                  <DialogContent>
                                    ...
                                    <div className="space-y-4">
                                      ...
                                      <div className="flex space-x-2">
                                        ...
                                        <Button onClick={handleInviteMember} className="flex-1 bg-gradient-primary">
                                          Send Invite
                                        </Button>
                                      </div>
                                    </div>
                                  ...
                                  <DialogContent>
                                    ...
                                    <div className="space-y-4">
                                      ...
                                      <div className="flex space-x-2">
                                        ...
                                        <Button onClick={handleShareVault} className="flex-1 bg-gradient-primary">
                                          Share Vault
                                        </Button>
                                      </div>
                                    </div>
