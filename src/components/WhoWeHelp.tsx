      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {industries.map((industry, index) => {
            ...
            return (
              <Card key={index} className={`hover:shadow-xl hover:-translate-y-2 transition-all duration-200 border-2 hover:border-primary/20 bg-gradient-to-br ${industry.gradient} hover:scale-105 cursor-pointer card-elevated group`}>
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <CardTitle className="text-lg text-black dark:text-black group-hover:text-gradient transition-all duration-300">{industry.title}</CardTitle>
                    </div>
                  </div>
                  <CardDescription className="text-black dark:text-black font-medium group-hover:text-primary transition-colors duration-300">
                    {industry.description}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-black dark:text-black leading-relaxed group-hover:text-gray-900 transition-colors duration-300">
                    {industry.details}
                  </p>
                </CardContent>
              </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {whyChooseUs.map((reason, index) => {
            ...
            return (
              <Card key={index} className="hover:shadow-xl hover:-translate-y-2 transition-all duration-200 text-center hover:scale-105 cursor-pointer card-elevated group">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg text-black dark:text-black group-hover:text-gradient transition-all duration-300">{reason.title}</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-black dark:text-black leading-relaxed group-hover:text-gray-900 transition-colors duration-300">
                    {reason.description}
